...
import { SigninApi, loginApi } from "../scrvices/api/api-firebase";
import { storedata } from "../scrvices/storge";
...
export default function Register() {
    ...
    const lhandleSubmit = (event) => {
        event.preventDefault();
        console.log("1handleSubmit is Sumbited!")
        let errors = initialState;
        let hasError = false;
    ...
    return (
        <Fragment>
            <div className="registration" id="myconfig">
                <Metadata title={"Regsiter"} />
                <div className="mycontent">
                    <div className="myoverlay"></div>
                    <img className="backarrow" src="/meterial/back-arrow.png" alt="" />
                    <img className="mybackground" src="/meterial/bg-1.jpg" alt="" />
                    <Link to={"/"}><div className="Home-icon"><i class="fa-solid fa-house-signal"></i></div></Link>
                </div>
                <div className="contain">
                    <div className="box">
                        ...
                        <form action="" id="login" onSubmit={lhandleSubmit}>
                            <div className={`box-img ${loginbtnstate ? "login-right-movement" : ""}`}>
                        ...
                        <form action="" id="signin" onSubmit={handleSubmit}>
                            <div className={`box-form ${loginbtnstate ? "signin-left-movement" : ""}`}>
                                <div className="inputname">
                                    <i className="fa fa-user"></i>
